...
public class EESKPSPublicSoap
{
    ...
    public EESKPSPublicSoap(){}

    public EESKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public EESKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        EESExtendedSoapSerializationEnvelope envelope= new EESExtendedSoapSerializationEnvelope(EESExtendedSoapSerializationEnvelope.VER11);
