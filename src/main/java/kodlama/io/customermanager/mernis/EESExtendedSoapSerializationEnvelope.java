...
class EESSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class EESExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(EESDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new EESStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static EESDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static EESDateTimeConverter dateTimeConverter = new EESStandardDateTimeConverter();

    public EESExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public EESExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new EESMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=EESHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,EESExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=EESHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
